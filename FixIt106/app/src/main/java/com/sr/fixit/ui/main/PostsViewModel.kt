...
import com.sr.fixit.BuildConfig
...
import com.sr.fixit.data.posts.PostsRepository
...
import com.sr.fixit.utils.GeminiApiClient
...
class PostsViewModel : ViewModel() {
    ...
    private fun prefs(context: Context) =
        context.getSharedPreferences("fixit_notif", Context.MODE_PRIVATE)
